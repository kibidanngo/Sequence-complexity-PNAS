...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 18 10:13:09 2024
...
def trajectory(H,lp,ens,seq):
    ...
    file='/home/rt24494/Research/IDP/Simulation/Glass/singlechain/H=%s/outputSingleChain%s_seq%s_lp=%s_eps=2.dcd' %(H,ens,seq,lp)  
    ...
    #topo=md.load('/home/rt24494/Research/IDP/Simulation/Glass/singlechain/H=%s/topology.pdb' % H )
    topo=md.load('/home/rt24494/Research/IDP/Simulation/Glass/singlechain/H=%s/initial_SingleChain.pdb' % H )
...
def file(tw,H,lp,ens,seq):
    ...
    file= 'MSD_pairs_SingleChain_tw=%s_H=%s_lp=%s_ens=%s.dat'%(tw,H,lp,ens)
    return file 
